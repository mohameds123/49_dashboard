...
import 'default_indicators/first_page_error_indicator.dart';
import 'default_indicators/first_page_progress_indicator.dart';
import 'default_indicators/new_page_error_indicator.dart';
import 'default_indicators/new_page_progress_indicator.dart';
import 'default_indicators/no_items_found_indicator.dart';
...
class _PagedSliverBuilderState<PageKeyType, ItemType>
  ...
  WidgetBuilder get _noItemsFoundIndicatorBuilder =>
      ...
      (_) => NoItemsFoundIndicator(
            textColor: widget.textColor,
            isMessageShow: widget.isMessageShow,
          );
