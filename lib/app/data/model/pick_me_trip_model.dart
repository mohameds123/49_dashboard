...
class PickMeTripModel extends Equatable with TimeAgoMixin {
  final String id;
  final String userId;
  ...
  factory PickMeTripModel.fromMap(Map<String, dynamic> map) {
    return PickMeTripModel(
